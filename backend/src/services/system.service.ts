...
export const systemService = {
  ...
  async getSystemDetails() {
    ...
    return {
      ...
      primaryAdapters: adapterRegistry.getPrimaryAdapters(),
      supplementaryAdapters: adapterRegistry.getSupplementaryAdapters(),
      indexingReady: adapterRegistry.hasPrimaryAdapters(),
      dryRunEnabled: adapterRegistry.isUsingDryRun(),
      noPrimaryAdapters: !adapterRegistry.hasPrimaryAdapters(),
